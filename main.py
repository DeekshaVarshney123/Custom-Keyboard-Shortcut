...
#         try:
#             # Dabi hui key ko set mein add karein.
#             self.pressed_keys.add(key)
#             print(f"Key pressed: {self.pressed_keys}")
            
#             # Shortcut format ke liye keys check karte hain.
#             key_sequence = None
#             if keyboard.Key.ctrl in self.pressed_keys and hasattr(key, 'char'):
#                 key_sequence = f"<Control-{key.char.lower()}>"
#             elif keyboard.Key.alt in self.pressed_keys and hasattr(key, 'char'):
#                 key_sequence = f"<Alt-{key.char.lower()}>"
#             elif hasattr(key, 'name'):
#                 key_sequence = f"<{key.name.lower()}>"
...
#         """Keyboard release events par call hone wala function."""
#         try:
#             # Jab key chhod di jaye to use set se hata dein.
#             if key in self.pressed_keys:
#                 self.pressed_keys.remove(key)
#             print(f"Key released. Current keys: {self.pressed_keys}")
